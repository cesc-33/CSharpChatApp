...
# ChatApp (C# TCP Chat)
> Current version: **v2.1.1** - June 2025
...
- Public and private chat (via user selection)
- End-to-end encryption (AES + RSA hybrid)
- Automatic AES key exchange
- Message formatting (Bold, Italic, Underline)
- New client list with avatars & hover effects
- WinForms GUI (.NET 9.0)
